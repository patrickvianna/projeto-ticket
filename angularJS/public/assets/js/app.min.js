"use strict";angular.module("myApp",["ngAnimate","ui.router","toastr","ngTouch","ui.bootstrap"]);
"use strict";angular.module("myApp").constant("consts",{appName:"Projeto ticket",version:"1.0",owner:"Patrick",year:"2018",site:"",apiUrl:"http://timbiras:3003/api",oapiUrl:"http://timbiras:3003/oapi",userKey:"_my_app_user"}).run(["$rootScope","consts",function(t,o){t.consts=o}]);
"use strict";angular.module("myApp").config(["$stateProvider","$urlRouterProvider","$httpProvider",function(t,e,i){t.state("ticketList",{url:"/ticketList",templateUrl:"template/ticket.list.html"}).state("newTicket",{url:"/newTicket",templateUrl:"template/ticket.new.html"}).state("login",{url:"/login",templateUrl:"template/login.html"}).state("ticketDetalhe",{url:"/detalhe-ticket/:idTicketRota",templateUrl:"template/ticket.detail.html"}),i.interceptors.push("handleResponseError")}]).run(["$rootScope","$http","$location","$window","auth",function(t,a,n,r,e){function i(){var i=e.getUser(),l="/auth.html",o=r.location.href.includes(l);i||o?i&&!i.isValid&&e.validateToken(i.token,function(t,e){e?(i.isValid=!0,a.defaults.headers.common.Authorization=i.token,o?r.location.href="/":n.path("/ticketList")):r.location.href=l}):r.location.href=l}i(),t.$on("$locationChangeStart",function(){return i()})}]);
...
"use strict";angular.module("myApp").component("paginator",{bindings:{url:"@",total:"@"},controller:["$location",function(a){this.$onInit=function(){var t=parseInt(this.total)||1;this.totalArray=Array(t).fill(0).map(function(t,n){return n+1});for(var n=[],r=startPage;r<=endPage;r++)n.push(r);this.current=parseInt(a.search().page)||1,this.needPagination=1<this.total,this.hasPrev=1<this.current,this.hasNext=this.current<this.total,this.isCurrent=function(t){return this.current==t}}}],template:'\n       <ul ng-if="$ctrl.needPagination"\n         class="pagination pagination-sm no-margin pull-right">\n         <li ng-if="$ctrl.hasPrev">\n           <a href="{{ $ctrl.url }}?page={{ $ctrl.current - 1}}">«</a>\n         </li>\n         <li ng-class="{active: $ctrl.isCurrent(i)}"\n           ng-repeat="i in $ctrl.totalArray">\n           <a href="{{ $ctrl.url }}?page={{i}}">{{i}}</a>\n         </li>\n         <li ng-if="$ctrl.hasNext">\n           <a href="{{ $ctrl.url }}?page={{ $ctrl.current + 1}}">»</a>\n         </li>\n       </ul>\n    '});
...
"use strict";angular.module("myApp").controller("LoginCtrl",["$http","Msg","Url","auth","$location",function(o,t,n,r,u){var e=this;e.loginMode=!0,e.user={login:"",senha:""},e.logar=function(){r.login(e.user,function(o){o?t.addError("Erro ao logar"):(u.path("/ticketList"),t.addSucess("Bem-vindo","Logado com sucesso!"))})},e.logout=function(){r.logout(function(){return u.path("/")})},e.getUser=function(){return r.getUser()}}]);
"use strict";angular.module("myApp").controller("NewTicket",["$scope","$http","Ticket","consts","Msg","$state",function(e,o,t,a,i,d){var r=this;r.severidade={idSeveridade:null,availableOptions:[{model:1,severidade:"Baixa"},{model:2,severidade:"Normal"},{model:3,severidade:"Alta"},{model:4,severidade:"Urgente"},{model:5,severidade:"Imediata"}]},r.tipo={idTipo:null,availableOptions:[{model:1,tipo:"Bug"},{model:2,tipo:"Funcionalidade"},{model:3,tipo:"Suporte"}]},r.projetos={lista:[],selectedOption:{id:"",name:""}},r.tarefa={idUser:"",titulo:"",descricao:"",tipo:"",prioridade:"",projeto:""},r.setTickets=function(){r.tarefa.tipo=r.tipo.idTipo,r.tarefa.prioridade=r.severidade.idSeveridade,r.tarefa.projeto=r.projetos.selectedOption.id,r.tarefa.idUser=JSON.parse(localStorage.getItem(a.userKey)).id,o.post(a.apiUrl+"/setTickets",r.tarefa).then(function(e){console.log(e),d.go("ticketList"),i.addSucess("Criado com sucesso")}).catch(function(e){console.log(e),i.addError("Ops, houve algo de errado")})},o.post(a.apiUrl+"/getProjetos",JSON.parse(localStorage.getItem(a.userKey))).then(function(e){r.projetos.lista=e.data,r.projetos.selectedOption=e.data[0]||"",console.log(e.data)}).catch(function(e){i.addError("Não foi possível carregar os projetos")})}]);
"use strict";angular.module("myApp").controller("TicketCtrl",["$scope","$http","$location","consts","$state","Msg","$q","$rootScope","$uibModal",function(t,s,e,a,o,r,n,i,c){var l=this;l.tickets={tarefas:""};var d={idUser:JSON.parse(localStorage.getItem(a.userKey)),init:"",max:10,project:""};l.projetos={lista:[],selectedOption:{id:"",name:""}},l.pager={atualPage:"",totalItens:"",totalPages:"",startPage:"",endPage:"",startIndex:"",endIndex:"",pages:""},l.detailTicket=function(o){c.open({template:'<detail-modal tarefa="$ctrl.tarefa" $close="$close(result)" $dismiss="$dismiss(reason)"></detail-modal>',controller:[function(){var e=this,t=o;s.post(a.apiUrl+"/getDetail",{rota:t}).then(function(t){e.tarefa=t.data.issue,console.log(e.tarefa)}).catch(function(t){console.log(t)})}],controllerAs:"$ctrl",size:"lg",resolve:{}}).result.then(function(t){console.info("I was closed, so do what I need to do myContent's controller now and result was->"),console.info(t)},function(t){console.info("I was dimissed, so do what I need to do myContent's controller now and reason was->"+t)})},l.newTicket=function(){c.open({template:'<new-modal projetos="$ctrl.projetos" $close="$close(result)" $dismiss="$dismiss(reason)"></new-modal>',controller:["projetos",function(t){this.projetos=t}],controllerAs:"$ctrl",size:"lg",resolve:{projetos:l.projetos}}).result.then(function(t){},function(t){"success"==t&&r.addSucess("Criado com sucesso"),l.getTicketProject()})},l.verTicket=function(t){o.go("ticketDetalhe",{idTicketRota:t})},l.getTicketProject=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:1;d.project=l.projetos.selectedOption.id,d.init=e,s.post(a.apiUrl+"/getTicketProject",d).then(function(t){l.tickets.tarefas=t.data.issues,l.pager.totalItens=t.data.total_count,l.pager=p(e,l.pager.totalItens)}).catch(function(t){r.addError("Não foi possível carregar os tickets")})};var p=function(t,e){var o=Math.ceil(e/10),s=void 0,a=void 0;o<=4?(s=1,a=o):t<=3?(s=1,a=4):o<=t+1?(s=o-3,a=o):a=(s=t)+1;for(var r=10*(t-1),n=Math.min(r+10-1,e-1),i=[],c=s;c<=a;c++)i.push(c);return{atualPage:t,pageSize:10,totalPages:o,startPage:s,endPage:a,startIndex:r,endIndex:n,pages:i}};n(function(e,o){s.post(a.apiUrl+"/getProjetos",JSON.parse(localStorage.getItem(a.userKey))).then(function(t){l.projetos.lista=t.data,l.projetos.selectedOption=t.data[0]||"",l.projetos.lista.length<1?(r.addError("Não há projetos associados a esse usuário"),o()):e()}).catch(function(t){r.addError("Não foi possível carregar os projetos")})}).then(function(t){l.getTicketProject()})}]);
"use strict";angular.module("myApp").service("TicketTs",function(e){});
"use strict";angular.module("myApp").controller("DetailCtrl",["$http","consts","$scope",function(o,t){var e=this,n=47;e.tarefa={},e.coment="",e.comentsLs=[],new Date,e.addComent=function(){console.log("ENTREI NO COMENTARIO");var o={descricao:e.coment,dateCreate:"12/01/2018 16:27"};e.comentsLs.push(o),e.coment="",console.log(e.comentsLs)},e.close=function(){e.$dismiss({reason:"cancel"})},o.post(t.apiUrl+"/getDetail",{rota:n}).then(function(o){e.tarefa=o.data.issue,console.log(e.tarefa)}).catch(function(o){console.log(o)})}]);
"use strict";angular.module("myApp").factory("auth",["$http","consts",function(e,a){var n=null;function o(){return n||(n=JSON.parse(localStorage.getItem(a.userKey))),n}function l(t,n,o){e.post(a.oapiUrl+"/"+t,n).then(function(t){localStorage.setItem(a.userKey,JSON.stringify(t.data)),e.defaults.headers.common.Authorization=t.data.token,o&&o(null,t.data)}).catch(function(t){o&&(console.log(t),o(t,null))})}function u(t){n=null,localStorage.removeItem(a.userKey),e.defaults.headers.common.Authorization="",t&&t(null)}return{signup:function(t,n){l("signup",t,n)},login:function(t,n){l("login",t,n)},logout:u,getUser:o,validateToken:function(t,n){t?e.post(a.oapiUrl+"/validateToken",{token:t}).then(function(t){t.data.valid?e.defaults.headers.common.Authorization=o().token:u(),n&&n(null,t.data.valid)}).catch(function(t){n&&n(t.data.errors)}):n&&n("Token inválido.")}}}]);
...
"use strict";angular.module("myApp").factory("handleResponseError",["$q","$window","consts",function(e,o,t){return{responseError:function(r){return 403===r.status&&(localStorage.removeItem(t.userKey),o.location.href="/"),e.reject(r)}}}]);
"use strict";angular.module("myApp").factory("Msg",["toastr",function(t){function o(r,n,o){r instanceof Array?r.forEach(function(r){return t[o](r,n)}):t[o](r,n)}return{addSucess:function(r){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"Sucesso";o(r,n,"success")},addError:function(r){var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"Erro";o(r,n,"error")}}}]);
"use strict";angular.module("myApp").factory("Ticket",function(){return function(t){var i=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:null,u=3<arguments.length&&void 0!==arguments[3]?arguments[3]:null;this.numRegistro=t,this.titulo=i,this.dtCriacao=n,this.status=u}});
