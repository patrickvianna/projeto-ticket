...
"use strict";!function(){angular.module("myApp").controller("TicketCtrl",["$scope","$http","$location","consts","$state","Msg",function(t,e,a,c,i,o){var r=this;r.tickets={tarefas:""};var s={idUser:JSON.parse(localStorage.getItem(c.userKey)),init:.1,max:10};r.verTicket=function(t){i.go("ticketDetalhe",{idTicketRota:t})},e.post(c.apiUrl+"/getTickets",s).then(function(t){r.tickets.tarefas=t.data}).catch(function(t){o.addError("Não foi possível carregar os tickets")})}])}();
