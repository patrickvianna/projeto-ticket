...
"use strict";!function(){angular.module("myApp").controller("TicketCtrl",["$scope","$http","$location","consts","$state","Msg","$q",function(t,e,o,c,r,a,s){var i=this;i.tickets={tarefas:""};var n={idUser:JSON.parse(localStorage.getItem(c.userKey)),init:.1,max:10,project:""};i.projetos={lista:[],selectedOption:{id:"",name:""}};i.verTicket=function(t){r.go("ticketDetalhe",{idTicketRota:t})};i.getTicketProject=function(){n.project=i.projetos.selectedOption.id,console.log(n),e.post(c.apiUrl+"/getTicketProject",n).then(function(t){console.log(t.data),i.tickets.tarefas=t.data}).catch(function(t){a.addError("Não foi possível carregar os tickets")})},(console.log("ENTREI"),s(function(t,o){e.post(c.apiUrl+"/getProjetos",JSON.parse(localStorage.getItem(c.userKey))).then(function(e){i.projetos.lista=e.data,i.projetos.selectedOption=e.data[0]||"",t()}).catch(function(t){a.addError("Não foi possível carregar os projetos"),o()})})).then(function(t){i.getTicketProject()})}])}();
